...
struct OnboardingView: View {
    ...
    private let pages: [OnboardingPage] = [
        OnboardingPage(
            title: "Welcome to ALLMYSCREENS",
            description: "**ALLMYSCREENS** splits your portrait monitors into fixed zone containers.\n\nHold **Shift** while dragging a window to snap it into a zone — the app fills only that slot, not the whole screen.\n\nUse **Quick Layouts** in the menu bar to apply Halves or Thirds to your monitors.\n\nLet's get started!",
            ...
            HStack(alignment: .center, spacing: 12) {
                HStack(spacing: 8) {
                    ...
                    VStack(alignment: .leading, spacing: 2) {
                        Text("Getting started with ALLMYSCREENS")
                            .font(.title2)
                            .fontWeight(.bold)
...
func showOnboarding() {
    let window = NSWindow()
    window.title = "Welcome to ALLMYSCREENS"
